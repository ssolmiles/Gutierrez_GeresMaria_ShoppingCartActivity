...
2. I also used AI to help me understand the concepts of GitHub and how to use it effectively for version control and collaboration.
	- I asked questions like:
		...
		- "What are the best practices for using GitHub in a team project?"
...
5. I also asked about classes
	...
	- How many methods to use in a class in C#?
6. What is the best type of flowchart to use for a shopping cart application: "What is the best type of flowchart to use for a shopping cart application?"